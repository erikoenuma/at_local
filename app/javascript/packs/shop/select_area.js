...
$('.region').change(function(e) {
  ...
  var prefectureForm = e.target.form.shop_prefecture;
  var areaForm = e.target.form.shop_place_id;
  var streetForm = e.target.form.shop_shopping_street_id;
  ...
  // 最初のエリアの商店街を表示
  showShoppingStreet(firstPlace.area, streetForm);

})

$('.prefecture').change(function(e) {
  const selectedPrefecture = e.target.form.shop_prefecture.value
  var areaForm = e.target.form.shop_place_id;
  showArea(selectedPrefecture, areaForm);

  var streetForm = e.target.form.shop_shopping_street_id;
  const firstPlace = places.filter(place => place.prefecture == selectedPrefecture)[0];
  console.log(firstPlace);
  showShoppingStreet(firstPlace.id, streetForm);
})

$('.area').change(function(e) {

  const area = e.target.form.shop_place_id.value;
  var streetForm = e.target.form.shop_shopping_street_id;
