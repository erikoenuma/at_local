...
class ShopsTest < ApplicationSystemTestCase
  ...
  test "creating a Shop" do
    ...
    fill_in "Access", with: @shop.access
    fill_in "Address", with: @shop.address
    fill_in "Cancelable days before", with: @shop.cancelable_days_before
    fill_in "Introduction", with: @shop.introduction
    fill_in "Name", with: @shop.name
    check "Private" if @shop.private
